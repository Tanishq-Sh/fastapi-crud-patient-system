...
class UserInput(BaseModel):
    ...
    height: Annotated[float, Field(..., gt=0, lt=2.5, description='Height of the user (m)')]
    income_lpa: Annotated[float, Field(..., gt=0, description='Annual salary of the user (LPA)')]
